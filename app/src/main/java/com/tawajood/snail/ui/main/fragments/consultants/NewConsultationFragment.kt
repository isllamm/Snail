...
@AndroidEntryPoint
class NewConsultationFragment : Fragment(R.layout.fragment_new_consultation) {


    private lateinit var binding: FragmentNewConsultationBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding = FragmentNewConsultationBinding.bind(requireView())
